...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/icon/logo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.pushButton_refresh_installed_mods.setMinimumSize(QSize(28, 28))
        self.pushButton_refresh_installed_mods.setMaximumSize(QSize(28, 28))
...
#endif // QT_CONFIG(tooltip)
        self.pushButton_refresh_installed_mods.setText("")
