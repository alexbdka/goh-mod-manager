...
class Ui_AboutDialog(object):
    ...
    def retranslateUi(self, AboutDialog):
        ...
        self.creditsLabel.setText(
            QCoreApplication.translate(
                "AboutDialog",
                '<html><head/><body><p><span style=" font-weight:600;">Credits:</span><br/>\u2022 Interface: <a href="https://doc.qt.io/qtforpython/"><span style=" text-decoration: underline; color:#55aaff;">Qt for Python (PySide6)</span></a><br/>\u2022 Icons: <a href="https://remixicon.com/"><span style=" text-decoration: underline; color:#55aaff;">Remix Icon, awasde</span></a><br/>\u2022 Developer: <a href="https://github.com/alexbdka"><span style=" text-decoration: underline; color:#55aaff;">alex6</span></a></p></body></html>',
                None,
            )
        )
        self.versionLabel.setText(
            QCoreApplication.translate(
                "AboutDialog",
                '<html><head/><body><p align="center">Version : <span\n'
